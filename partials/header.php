...
<body<?= !empty($body_class) ? ' class="' . attr($body_class) . '"' : '' ?>>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TNH27Q9Z" height="0" width="0"
        ...
        <header class="main-header header-style-one header-1">
                ...
                <div class="container">
                    <div class="header-top-inner">
                        ...
                        <div class="header-top-left">
                            ...
                            <a href="https://www.instagram.com/quantalai_/" target="_blank" rel="noopener"
                                aria-label="Instagram">
                                <i class="fa-brands fa-instagram"></i>
                            </a>

                            <a href="https://www.upwork.com/agencies/1866102204539548169/" target="_blank"
                            ...
                            <a href="https://www.glassdoor.co.in/Overview/Working-at-Quantal-AI-EI_IE10895843.11,21.htm"
                                target="_blank" rel="noopener" aria-label="Glassdoor">
                        ...
                        <div class="header-left">
                            <div class="logo">
                                <a href="<?= attr(BASE_URL) ?>" title="<?= attr(SITE_NAME) ?>" class="brand-logo">
                                    <img src="<?= asset('images/brain-logo.png') ?>" alt="<?= attr(SITE_NAME) ?>"
                                        title="<?= attr(SITE_NAME) ?>" style="max-height:46px;width:auto;">
                        ...
                        <div class="outer-box">
                            <div class="ui-btn-outer">
                                <div class="ui-btn-search">
                                    <button
                                        class="ui-btn ui-btn search-btn main-header__search search-toggler d-none d-lg-inline-block"
                                        aria-label="Search">
                                        <i class="fa-regular fa-magnifying-glass"></i>
                                    </button>
                                    <a href="<?= url('/contact') ?>" class="header-btn d-none d-lg-block">Let&rsquo;s
                                        Talk</a>
                                </div>
                            </div>
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="upper-box">
                        <div class="nav-logo">
                            <a href="<?= attr(BASE_URL) ?>" class="brand-logo"><img
                                    src="<?= asset('images/brain-logo.png') ?>" alt="<?= attr(SITE_NAME) ?>"
                                    style="max-height:42px;"><span class="brand-title">Quantal AI</span></a>
                        </div>
                    ...
                    <ul class="social-links">
                        <li><a href="https://www.linkedin.com/company/quantal-ai" target="_blank" rel="noopener"
                ...
                <div class="large-container">
                    <div class="inner-container">
                        <div class="logo">
                            <a href="<?= attr(BASE_URL) ?>" title="<?= attr(SITE_NAME) ?>" class="brand-logo">
                                <img src="<?= asset('images/brain-logo.png') ?>" alt="<?= attr(SITE_NAME) ?>"
                                    title="<?= attr(SITE_NAME) ?>" style="max-height:42px;width:auto;">
                                <span class="brand-title">Quantal AI</span>
                            </a>
                        </div>
                        <div class="nav-outer">
