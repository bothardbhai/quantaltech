            ...
            <div class="col-xl-8 col-lg-8">
                <div class="services-details__content">
                    ...
                    <?php if (!empty($platforms)): ?>
                        <div class="ai-platforms-section pb-50">
                    ...
                    <?php if (!empty($impact_stats)): ?>
                        <section class="impact-section pb-50">
                            <div class="container">
                                <div class="row g-4">
                    ...
                    <div class="brand-section-2 pb-50">
                        <div class="container">
                                        ...
                                        foreach ($clients as $client):
                                            ...
                                            <div class="swiper-slide">
                                                <div class="brand-img2 image-fluid">
                                                    <img src="<?= asset('images/quantal/clients/' . $client[0]) ?>"
                                                        alt="<?= attr($client[1]) ?>">
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                        ...
                        <div class="sidebar-widget service-sidebar-single mt-4">
                            <div class="service-sidebar-single-btn wow fadeInUp" data-wow-delay="0.5s"
                                ...
                                <a href="<?= url('/contact') ?>" class="theme-btn btn-style-one d-grid">
                                    <span class="btn-title"><span class="fas fa-paper-plane"></span> Schedule a
                                        Demo</span>
                                </a>
                            </div>
                        </div>
