...
// "Success Stories That Transform Businesses" — latest 4 published Success
// Stories (image, title, category, detail URL), newest first.
$home_success_stories = [];
if ($pdo) {
  $home_ss_category_map = [];
  foreach (get_success_story_categories($pdo, []) as $home_ss_cat) {
    $home_ss_category_map[(int) $home_ss_cat['id']] = $home_ss_cat['name'];
  }
  foreach (array_slice(get_success_stories($pdo, ['status' => 'published', 'order' => 'created_at DESC, id DESC']), 0, 4) as $home_ss) {
    $home_success_stories[] = [
      'title' => $home_ss['title'],
      'category' => $home_ss_category_map[(int) ($home_ss['category_id'] ?? 0)] ?? '',
      'image' => media_url($home_ss['featured_image']),
      'url' => url('/success-stories/' . $home_ss['slug']),
    ];
  }
}
?>

<section class="hero-section fix hero-1 bg-cover"
  style="background-image: url('<?= asset('images/home-1/hero/hero-bg.jpg') ?>');">
    ...
    <div class="row g-xl-0 g-4 align-items-center pt-5">
      <div class="col-xl-9">
        <div class="hero-content">
          ...
          <div class="content">
            <p class="wow fadeInUp" data-wow-delay=".3s">Production-ready AI systems built by experienced engineers. We
              help businesses turn AI into real, measurable outcomes &mdash; from voice bots and chat flows to vision
...
<section class="about-section section-padding fix">
  ...
  <div class="about-shape d-none d-xxl-block"><img src="<?= asset('images/home-1/about/about-shape.png') ?>" alt="img">
  </div>
    ...
    <div class="row g-4">
          ...
          <div class="about-circle-box">
            <div class="circle-text">
              <svg viewBox="0 0 250 250">
                ...
                <text>
                  <textPath xlink:href=" #circlePath" startOffset="0%">AI Projects Delivered ~ AI Projects Delivered ~
                  </textPath>
                </text>
              </svg>
            </div>
      ...
      <div class="col-xl-6 col-lg-10">
        <div class="about-content1">
          ...
          <p class="about-text wow fadeInUp" data-wow-delay=".3s">Quantal AI is a GenAI engineering studio. We help
            companies move beyond experimentation by designing and deploying intelligent systems &mdash; from AI agents
            and automation platforms to knowledge systems and generative AI applications.</p>
          <div class="about-box wow fadeInUp" data-wow-delay=".5s">
            <h6 class="para-text">We don&rsquo;t just prototype AI &mdash; we build systems that run in production. With
              15+ years of combined expertise and 100% job success on Upwork, we deliver AI that fits your operations
              and scales with your business.</h6>
          </div>
...
<section class="skill-section1 section-padding section-bg bb-top">
          ...
          <div class="skill-feature-items wow fadeInUp" data-wow-delay=".3s">
            <div class="skill-feature">
              ...
              <div class="progress style-2">
                <div class="progress-bar"
                  style="width: 83%; animation: 2.6s ease 0s 1 normal none running animate-positive; opacity: 1;">
              ...
              <div class="progress style-4">
                <div class="progress-bar"
                  style="width: 95%; animation: 2.6s ease 0s 1 normal none running animate-positive; opacity: 1;">
    ...
    <div class="row g-4">
      ...
      <div class="col-xxl-7">
        <div class="row design-choose-item-wrap">
          <?php
          // Same 4 positional wrapper classes as the original hardcoded
          // markup — purely cosmetic per-slot variants, not tied to data.
          $home_ss_slot_classes = [
          ...
          foreach ($home_success_stories as $i => $home_ss):
            $story = $home_ss;
            $slot_class = $home_ss_slot_classes[$i] ?? 'case-block';
            ?>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
          <div class="team-block team-item">
            ...
            <div class="social-icon">
              <a href="https://www.linkedin.com/in/shaileshkumarjain/" target="_blank" rel="noopener"><i
        ...
        <div class="cards-content">
          <div class="award-block">
            <div class="head">
              ...
              <div class="icon">
                <img src="<?= asset('images/home-1/award/award-icon.webp') ?>"
                  alt="Production AI Projects Delievered - Award Winner">
              </div>
            </div>
            <h4 class="title">
      ...
      <div class="col-xl-5 col-lg-5">
        <div class="right-content">
          ...
          <p class="text wow fadeInUp" data-wow-delay=".3s">
            Senior AI engineers, fast onboarding without long hiring cycles, production-first systems &mdash; with 100%
            transparent communication and delivery from planning to deployment.
          </p>
          ...
          <div class="image right-to-left-ani">
            <img src="<?= asset('images/home-1/award/award-01.webp') ?>"
              alt="Production-ready AI systems built by Quantal AI">
          </div>
        </div>
      </div>
    </div>
...
<div class="multiple-section section-bg-2 section-padding pb-0">
  <div class="inner section-bg section-padding">
    <div class="bg-image bg-cover" style="background-image: url(<?= asset('images/home-1/multiple-sec-bg.jpg') ?>);">
    </div>
    ...
    <section class="work-wrapper work-one">
      <div class="auto-container">
        <div class="section-title text-center">
          ...
          <h2 class="title split-text split-in-right">Production AI Through <br> <span> Step-by-Step Engineering</span>
          </h2>
        </div>
        <div class="cards-content">
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
              ...
              <div class="work-block">
                ...
                <div class="inner-box">
                  ...
                  <p class="text">We map your operations, identify the highest-leverage AI opportunities, and define
                    success metrics with you.</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
              <div class="work-block">
                ...
                <div class="inner-box">
                  ...
                  <p class="text">We design AI systems built for scale &mdash; LLM selection, data pipelines,
                    integrations, and security from day one.</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
              <div class="work-block">
                ...
                <div class="inner-box">
                  ...
                  <p class="text">Senior AI engineers ship production systems &mdash; voice agents, automation flows,
                    vision pipelines, integrations.</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
              <div class="work-block">
                ...
                <div class="inner-box">
                  ...
                  <p class="text">Continuous monitoring, model tuning, and expansion as your business grows. AI that
                    compounds.</p>
                </div>
              </div>
            </div>
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="testimonial-block">
                      <p class="text">&ldquo;Quantal AI and Team are EXPERTS at building ANY AI functionality
                        you&rsquo;re seeking! We&rsquo;ve hired them for 2 projects already &mdash; each completed ON
                        TIME and UNDER BUDGET. Highly Recommended!&rdquo;</p>
                      <div class="infu">
                        <div class="image">
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-block">
                      <p class="text">&ldquo;Working with Quantal AI team has been an absolute pleasure. Their technical
                        aptitude is outstanding &mdash; they&rsquo;re not only highly competent but also creative,
                        thoughtful, and reliable. They built a complex integration for our wine business connecting
                        PhotoRoom, Google Cloud, AWS, and Shopify, and it works beautifully.&rdquo;</p>
                      <div class="infu">
                        <div class="image">
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-block">
                      <p class="text">&ldquo;It was a pleasure working with Quantal AI team. Communication was smooth,
                        deadlines were respected, and the overall collaboration was professional and efficient. I would
                        definitely consider working together again in the future. Recommended!&rdquo;</p>
                      <div class="infu">
                        <div class="image">
