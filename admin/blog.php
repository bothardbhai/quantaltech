    ...
    (function() {
        ...
        ClassicEditor
            .create(document.querySelector('#body_html'), {
                ...
                // CKEditor 5's built-in default silently maps "Heading 1" -> <h2>,
                // "Heading 2" -> <h3>, etc. (reserving <h1> for the page's own
                // title). That's an unannounced offset, not a deliberate choice
                // here, so map each toolbar label to the tag it names.
                heading: {
                    options: [
